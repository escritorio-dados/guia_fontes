      ...
      <ConteudoContainer>
        <Container maxWidth="lg">
          ...
          <Typography>
            ...
            industriais, depositados ou registrados, bem como todos os direitos referentes a
            terceiros que porventura estejam disponíveis na busca. O simples acesso ao serviço e aos
            dados não confere aos usuários qualquer direito ao uso dos nomes, títulos, palavras,
            frases, marcas, patentes, imagens, dados e informações, dentre outras, que estejam
            disponíveis. Também, estão excluídas quaisquer possibilidades de uso para fins
            comerciais e publicitários ou qualquer outra natureza que fuja da proposta para que o
            Guia de Fontes foi criado.
          </Typography>
        </Container>
      </ConteudoContainer>
    </>
