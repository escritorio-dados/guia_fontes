...
export function SearchDocentesPesquisa() {
  ...
  useEffect(() => {
    void getDocentes({ params: { imprensa: false, ...removeEmptyFields({ query: pesquisa }) } });
      ...
      <Header>
        ...
        <HomeContainer maxWidth="lg">
          <Box>
            ...
            <Typography>Atividades educacionais (treinamentos, capacitações)</Typography>
          </Box>
        </HomeContainer>
      </Header>
